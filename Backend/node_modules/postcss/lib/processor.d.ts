...
import LazyRespostcss/lib/lazy-result.jss/lib/lazy-result.js'
importpostcss/lib/no-work-result.js'postcss/lib/no-work-result.js'
import {
  AcceptedPlugin,
  Plugin,
  ProcessOptions,
  TransformCapostcssansformer
} from 'postpostcss/lib/result.js Result from 'postcspostcss/lib/root.jsult.js'
