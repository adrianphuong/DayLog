...
import type { SourceMapV3, DecodedSourceMap, EncodedSourceMap, InvalidOriginalMapping, OriginalMapping, InvalidGeneratedMapping, GeneratedMapping, SourceMapInput, Needle, SourceNeed@jridgewell/trace-mapping/dist/types/typesrceMap, EachMapping } from '@jridgewell/tr@jridgewell/trace-mapping/dist/types/sourcemap-segmentpes/types';
export type { SourceMapSegment } from '@jridgewell/trace-mapping/dist/types/sourcemap-segment';
export type { SourceMapInput, SectionedSourceMapInput, DecodedSourceMap, EncodedSourceMap, SectionedSourceMap, InvalidOriginalMapping, Orig@jridgewell/trace-mapping/dist/types/typesping as Mapping, OriginalMapping, InvalidGeneratedMapping, GeneratedMapping, EachMapping, } from '@jridgewell/trace-mapping/dist/types/types';
...
/**
 * Returns a sourcemap object (with encoded mappings) suitable for passing to a library that ex@jridgewell/trace-mapping/dist/types/any-mapa sourcemap, or to JSON.stringify.
 */
